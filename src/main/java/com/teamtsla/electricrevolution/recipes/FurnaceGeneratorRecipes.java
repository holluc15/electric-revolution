package com.teamtsla.electricrevolution.recipes;
...
public class FurnaceGeneratorRecipes
{
    private static final FurnaceGeneratorRecipes INSTANCE = new FurnaceGeneratorRecipes();
    private final Table<ItemStack, ItemStack, ItemStack> smeltingList = HashBasedTable.<ItemStack, ItemStack, ItemStack>create();
    private final Map<ItemStack, Float> experienceList = Maps.<ItemStack, Float>newHashMap();

    public static FurnaceGeneratorRecipes getInstance()
    {
        return INSTANCE;
    }

    private FurnaceGeneratorRecipes()
    {

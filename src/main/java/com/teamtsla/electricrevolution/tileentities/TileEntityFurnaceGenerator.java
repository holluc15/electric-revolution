...
public class TileEntityFurnaceGenerator extends TileEntity implements ITickable {
    ...
    public static boolean isBurning(TileEntityFurnaceGenerator te)
    {
    ...
    public void update()
    {
        ...
        {
            --this.burnTime;
            FurnaceGenerator.setState(true, world, pos);
        }
        ...
        else
        {
            ...
            {
                ItemStack output = FurnaceGeneratorRecipes.getInstance().getSinteringResult(inputs[0], inputs[1]);
                if(!output.isEmpty())
                {
                    smelting = output;
                    cookTime++;
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack result = FurnaceGeneratorRecipes.getInstance().getSinteringResult((ItemStack)this.handler.getStackInSlot(0), (ItemStack)this.handler.getStackInSlot(1));

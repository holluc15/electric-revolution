package com.teamtsla.electricrevolution.worldgen;
    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
        ...
        switch(world.provider.getDimension()) {
            ...
            case -1:
                break;
            //Overworld
            case 0: runGenerator(Blocks.NOTEBLOCK.getDefaultState(), 7, 10, 12, 50, BlockMatcher.forBlock(Blocks.STONE), world, random, chunkX, chunkZ);
                break;
            //End
            case 1:
                break;
